...
<body>
						...
						<div class="menu-grids wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							...
							<div class="col-md-4 menu-grid1 simpleCart_shelfItem">
								...
								<div class="cur">
									...
									<div class="cur-right">
										<div class="item_add"><span class="item_price"><h6><span>只要</span>￥95.00</h6></span></div>
									</div>
										<div class="clearfix"> </div>
								</div>
								</div>
								...
								<div class="cur">
									...
									<div class="cur-right">
										<div class="item_add"><span class="item_price"><h6><span>只要</span> ￥75.00</h6></span></div>
									</div>
										<div class="clearfix"> </div>
								</div>
								</div>
								...
								<div class="cur">
									...
									<div class="cur-right">
										<div class="item_add"><span class="item_price"><h6><span>只要</span>￥65.00</h6></span></div>
									</div>
										<div class="clearfix"> </div>
								</div>
								</div>
							...
							<div class="col-md-4 menu-grid1 simpleCart_shelfItem">
								...
								<div class="cur">
									...
									<div class="cur-right">
										<div class="item_add"><span class="item_price"><h6><span>只要</span> ￥55.00</h6></span></div>
									</div>
										<div class="clearfix"> </div>
								</div>
								</div>
								...
								<div class="cur">
									...
									<div class="cur-right">
										<div class="item_add"><span class="item_price"><h6><span>只要</span> ￥85.00</h6></span></div>
									</div>
										<div class="clearfix"> </div>
								</div>
								</div>
	...
	<div class="footer-section">
					<div class="container">
						...
						<p>Copyright &copy; 2019.Company name All rights reserved.More Templates by liagnqiwen</p>
					</div>
					<script type="text/javascript">
